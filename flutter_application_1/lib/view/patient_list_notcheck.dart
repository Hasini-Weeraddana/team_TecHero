...
import 'package:flutter_application_1/view/patient_details.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

class PatientListScreennotCheck extends StatefulWidget {
  @override
  _PatientListScreennotCheckState createState() =>
      _PatientListScreennotCheckState();
}

class _PatientListScreennotCheckState extends State<PatientListScreennotCheck> {
  int? doctorId;
  String? mediRegNum;
  ...
  _fetchMediRegNum(int id) async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        _fetchPatientsNotCheck(mediRegNum!);
      });
    } else {
  ...
  _fetchPatientsNotCheck(String mediRegNum) async {
    final patientsData = await _fetchPatients(mediRegNum);

    setState(() {
      patients =
          patientsData.where((patient) => patient['is_check'] == 0).toList();
